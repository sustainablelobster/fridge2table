...
"""
import DbProto as db

recipe_dict = [{"recipe": "test1", "ingredients": ["chicken", "peas"], "url": "123"},
               {"recipe": "test2", "ingredients": [
                   "chicken", "peas"], "url": "1234"},
               {"recipe": "test3", "ingredients": ["chicken", "rice"], "url": "12345"}]
#
user_list = ["chicken", "peas", "rice"]

dbOps = db.DbProto("prototypes/fridgetomeal/dbPrototype/protoDB.db")
